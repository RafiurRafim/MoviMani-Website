...
namespace MoviMani.DataAccess.Migrations
{
    ...
    [Migration("20230811194103_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoviMani.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviMani.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviMani.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviMani.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviMani.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviMani.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviMani.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviMani.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MoviMani.Models.OrderDetail", b =>
                {
                    b.HasOne("MoviMani.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoviMani.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MoviMani.Models.OrderHeader", b =>
                {
                    b.HasOne("MoviMani.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MoviMani.Models.Product", b =>
                {
                    b.HasOne("MoviMani.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("MoviMani.Models.ApplicationUser", b =>
                {
                    b.HasOne("MoviMani.Models.Company", "Company")
                        .WithMany()
